...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOC, FR_ARRAY_OUTA_Pin|BAT_MEASURE_Pin);

    HAL_GPIO_DeInit(RR_ARR_OUT_GPIO_Port, RR_ARR_OUT_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC1     ------> ADC2_IN11
    */
    HAL_GPIO_DeInit(FR_ARRAY_OUTB_GPIO_Port, FR_ARRAY_OUTB_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, RR_ENCODER_A_Pin|RR_ENCODER_B_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, BLUTOOTH_TX_Pin|BLUTOOTH_RX_Pin);
